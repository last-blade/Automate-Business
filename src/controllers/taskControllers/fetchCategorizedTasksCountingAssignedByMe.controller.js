...
const fetchCategorizedTasksCountingAssignedByMe = asyncHandler(async (request, response) => {
    ...
    if(allTasksCounting.length === 0){
        return response.status(200)
        .json(
            new apiResponse(200, {}, "No task found")
        )
    }
...
export {fetchCategorizedTasksCountingAssignedByMe}